...
public class Login {
    ...
    private void carrgarImagens(){
        ...
        senhaImg = new ImageIcon(this.getClass().getResource("Senha.png"));
        loginImg = new ImageIcon(this.getClass().getResource("Login2.png"));
       
        labelSenha = new JLabel(); 
        labelLogin = new JLabel();
        
        labelLogin.setBounds(617, 149, 30, 30);
        labelSenha.setBounds(617, 200, 30, 30);
        
        labelLogin.setIcon(loginImg);
        labelSenha.setIcon(senhaImg);
