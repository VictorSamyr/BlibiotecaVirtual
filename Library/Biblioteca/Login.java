...
public class Login {
    ...
    private void carrgarImagens(){
        ...
        labelLogin.setIcon(new ImageIcon(this.getClass().getResource("Icones/LoginIcone.png")));
        labelSenha.setIcon(new ImageIcon(this.getClass().getResource("Icones/SenhaIcone.png")));
        labelLogo.setIcon(new ImageIcon(this.getClass().getResource("Icones/BibliotecaIcone1.png")));
        lblFechar.setIcon(new ImageIcon(this.getClass().getResource("Icones/BotaoFechar.png")));
