...
public class Registro{
    ...
    private void carrgarImagens(){
        ...
        lblLogo  = new JLabel();
        lblFechar.setIcon(new ImageIcon(this.getClass().getResource("Icone/BotaoFechar.png")));
        lblLogo.setIcon(new ImageIcon(this.getClass().getResource("Icones/BibliotecaIcone1.png")));
